    ...
    <footer className="bg-gray-900 text-white">
        ...
        <div className="bg-yellow-400 text-black w-full md:w-1/3 px-4 sm:px-6 py-12 md:py-16 flex flex-col justify-between">
          <div>
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl sm:text-2xl font-bold">AL AIN CAR Towing</h3>
            </div>
          ...
          <div className="flex gap-2 sm:gap-3 flex-wrap">
            ...
            <a href="https://wa.me/971569284977" aria-label="WhatsApp" className="w-8 h-8 sm:w-10 sm:h-10 bg-black text-yellow-400 rounded-full flex items-center justify-center hover:bg-gray-800 transition">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-12">
            ...
            <div>
              ...
              <ul className="space-y-2 sm:space-y-3 text-gray-300">
                ...
                <li><a href="mailto:alaincartowing@gmail.com" className="text-gray-300 hover:text-yellow-400 transition flex items-center gap-3"><span className="text-yellow-400 text-lg">✉</span> alaincartowing@gmail.com</a></li>
      ...
      <div className="bg-black/3 text-center py-6 px-4">
        <p className="text-gray-400 text-sm">
          Copyright © {currentYear} Al Ain Car Towing by Skill Ka Safar. All Rights Reserved.
        </p>
      </div>
    </footer>
  );
