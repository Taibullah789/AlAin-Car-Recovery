  ...
  return (
    <section className='py-0' ref={ref}>
      <div className='flex flex-col lg:flex-row min-h-[500px] md:min-h-[600px]'>
        ...
        <div className={`w-full lg:w-1/2 bg-yellow-400 text-black px-6 md:px-12 py-16 md:py-20 flex flex-col justify-center items-center ${isVisible ? 'fade-in-visible' : 'fade-in'}`}>
        ...
        <div className={`w-full lg:w-1/2 bg-gray-800 text-white px-6 md:px-12 py-16 md:py-20 flex flex-col justify-center ${isVisible ? 'fade-in-visible fade-in-delay-2' : 'fade-in'}`}>
