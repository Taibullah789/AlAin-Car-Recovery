...
export default function Gallery(){
  ...
  function GalleryItem({ image, index }) {
    ...
    return (
      <div 
        ref={ref}
        className={`relative overflow-hidden rounded-lg shadow-md hover:shadow-xl transition-all duration-700 group cursor-pointer ${
          isVisible 
      ...
      >
        ...
        />
        <div className='absolute inset-0 bg-blue-600 bg-opacity-0 group-hover:bg-opacity-70 transition flex items-center justify-center'>
          <h3 className='text-white font-bold text-lg opacity-0 group-hover:opacity-100 transition'>
            {image.title}
          </h3>
        </div>
      </div>
    ...
    <section className='py-20 bg-gray-50'>
      <div className='container mx-auto px-4'>
        <div className='text-center mb-12'>
          ...
          <p className='text-lg text-gray-600'>See our team in action providing professional towing services</p>
        </div>
